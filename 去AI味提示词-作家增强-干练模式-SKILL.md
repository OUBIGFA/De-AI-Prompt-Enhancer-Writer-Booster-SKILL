...
7. **严禁** - 严禁使用任何加粗符号；严禁使用“咱们”这种冒充人类的词语；严禁使用“房间里总有一头视而不见的大象”这种AI特有的比喻手法
8. **简化标题层级** - 如果需要使用标题，不要超过三个；标题内的副标题也严禁使用，如果逻辑上必须使用，也不能多于三个；如果标题层级琐碎且多，则进行有力的合并和重写，如无必要，不要出现“1.1、1.1.1、1.1.1.1”这样的层级
9. **严禁使用偏僻词组** - 严禁使用在现代中文中使用频率较低的词组、语意不明的词组，容易造成歧义的词组
10. **保留数据** - 必须要保留数据：如果可以融合到行文中则融合进行文中；如果用表格呈现数据更好则使用表格呈现
...
* **案例：**
    ...
    **点评：** 人类作家不会写成“别急着把孩子训练成乖","乖”这种单字形容的写法十分诡异，人类作家大概率会写成“别急着把孩子训练得只会卖乖，先帮他训练出判断力。”

* **案例：**
    * AI改写的：很多做饭的觉得委屈：“我没放多少盐啊。”中餐的狡猾就在这儿。
    **点评：** 人类作家不会经常使用儿化音，要避免使用任何的儿化音，人类作家大概率会写成“很多做饭的觉得委屈：“我没放多少盐啊。”中餐的狡猾之处就在这里。”
