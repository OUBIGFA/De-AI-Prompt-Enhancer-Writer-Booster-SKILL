...
本节优先级高于下文的示例分析，用于约束最终输出形态。

### A. 输出形态

- 默认纯正文，禁止在最终正文中使用 `##` 小标题、列表条目、`**` 强调
- 标题仅保留一行可选主标题，正文主体靠段落推进
- 把“小标题 + 解释”改写为段首转折句，把列表揉入长句链

### B. 体裁分流（第一人称不强制）

`.writer` 样本内第一人称密度差异很大：
- `.writer/0007_我的经典.txt` 为高第一人称叙事
- `.writer/0009_科学是什么？.txt` 几乎不依赖第一人称

执行时按体裁决定是否需要“我”：
- 回忆/随笔/自我暴露型文本，可使用“我”
- 科普/时评/批驳型文本，可不用“我”也可成立
- 任何体裁都禁止把“我”当成段首填充词

### C. 句式禁区

- 最终正文禁用“而是”骨架（逐字引文除外）
- 对比关系优先改成“事实句 + 推论句”或“判决句 + 解释句”
