<!-- 主副本在 de-AI-writing/references/，good-writing 同名文件必须与之逐字一致；改动请同步两处。 -->
...
对齐训练让模型系统性地压低一批人类日常用得很多的表达，结果是 AI 中文即使删光了黑名单词，读起来仍然"太干净、太书面、太均匀"。去 AI 味不只是做减法：原文本来有、被模型磨掉的东西要放回来。本条只恢复原文或作者自身语域里本来就有的，不注入新风格；叠加 good-writing 时，作者的文言虚词和书面习惯按 good-writing 自己的 `style-summary.md` 处理。
