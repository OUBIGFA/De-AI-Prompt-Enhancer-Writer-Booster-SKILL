...
体裁弹性（科普/信息综述类放松）
- 信息综述、深度科普、百科式介绍类文章：段落上限可放松到10-12段，段长下限可降到150字，小标题上限放松到4-5个（仍禁止对仗式）
- 评论/杂文/散文/书评类：维持上述标准不变
...
- [ ] **段落密度**：每段是否≥150字？评论/散文类全文正文是否≤8段？科普/信息类是否≤12段？是否消除了所有碎段？
...
- [ ] **结构**：首尾是否呼应？段落间是否消除了学术过渡词？评论/散文类是否无小标题（或≤3个）？科普/信息类小标题是否≤5个且非对仗式？
