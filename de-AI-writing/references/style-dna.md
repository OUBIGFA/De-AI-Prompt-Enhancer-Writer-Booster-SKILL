...
- **信息综述/深度科普**（如"科学普及塑造第一科技强国"）：10-12段，平均段长约200字，小标题比散文更常见（参考 2-4 个，按内容长度评估），语体更偏书面白话，文言虚词插入较少

因此"≤8段"的规则适用于评论/散文类；信息综述/科普类可放松到10-12段，小标题数量按内容长度评估，3-4 个是常见甜点位（仍禁止对仗式）。
...
| 固然 | 让步（虽然） | 让步分句，后必接"但/而/却" | 独立判断句（无转折承接） |
...
第一人称“我”**不是默认必备**。信息综述、科普、客观分析类常以无主语判断推进；只有作者在场的体裁（个人评论、书评、随笔）才自然带“我”。改写/翻译时不主动注入原文没有的“我”。

### 知识分子式的"我"（如使用）

一旦使用，“我”必须是**思维主体在标定立场**，不是感受主体在描述情绪：
...
原作者当然会用冒号，但在现代改写任务里应当按更严约束执行：正文目标 0-2 个，且几乎只在**直接引语提示语**中保留（后面紧跟引号或引文块）。
